    ...
    def t(self):
        ...
        with self.client.request(
            ...
            headers={
                ...
                "Referer": "http://localhost:8000/account/login/?next=%2F",
        ...
        with self.rest(
            ...
            headers={
                ...
                "Cookie": "csrftoken=twhG0zormRBZfIn5QFW8l33CRjr2awWKWeAHAZYzGdldGIR8lTnzGugAnizn4ACX; messages=W1siX19qc29uX21lc3NhZ2UiLDAsMjUsIlN1Y2Nlc3NmdWxseSBzaWduZWQgaW4gYXMgYWRtaW4uIl1d:1sMMvz:PHGIyQm96XDuSSJZXEci1G2qZUbMVnpH_-tykNn09go; sessionid=ybv5uq6wqy0xft0kf4ymlqsli5q9gtot",
                "Host": "localhost:8000",
                "Referer": "http://localhost:8000/datasets/geonode:gis_osm_adminareas_a_07_1/embed?config=dataset_preview",
                "Sec-Fetch-Dest": "empty",
                "Sec-Fetch-Mode": "cors",
                "Sec-Fetch-Site": "same-origin",
                "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36",
        ...
        with self.client.request(
            ...
            headers={
                ...
                "If-Modified-Since": "Fri, 21 Jun 2024 12:28:27 GMT",
                "If-None-Match": '"667571eb-47e"',
                "Referer": "http://localhost:8000/datasets/geonode_data:geonode:gis_osm_adminareas_a_07_1/metadata_detail",
                "Sec-Fetch-Dest": "image",
                "Sec-Fetch-Mode": "no-cors",
                "Sec-Fetch-Site": "same-origin",
                "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36",
        ...
        with self.client.request(
            ...
            headers={
                ...
                "If-Modified-Since": "Fri, 21 Jun 2024 12:28:27 GMT",
                "If-None-Match": '"667571eb-47e"',
                "Referer": "http://localhost:8000/account/logout/?next=/",
                "Sec-Fetch-Dest": "image",
                "Sec-Fetch-Mode": "no-cors",
                "Sec-Fetch-Site": "same-origin",
                "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36",
